...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo"><img  id=aimg src="images/logo.png" alt="" width="100px" ></a>
      ...
      <div class="icons">
         ...
         <a href="cart.php"><i class="shopping-cart11"></i><span><?= $total_cart_counts; ?></span><img src="images/cart.png"width="35px"></a>
      ...
      <div class="profile">
         ...
         <!-- <div class="flex-btn"> -->
            ...
            <p> <a href="user_login.php">login &nbsp;</a> | <a href="user_register.php"  >register</a> </p>
         <!-- </div> -->
